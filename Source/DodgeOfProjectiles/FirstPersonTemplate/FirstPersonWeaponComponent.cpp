...
void UFirstPersonWeaponComponent::Fire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			const FTransform MuzzleTransform = GetSocketTransform("Muzzle");
...
bool UFirstPersonWeaponComponent::AttachWeapon(ACharacter* TargetCharacter)
{
	...
	if (!ensureMsgf(AttachToComponent(Character->GetMesh(), AttachmentRules, FName(TEXT("GripPoint"))), TEXT("Failed attach weapon to character %s."), *Character->GetName()))
	{
		return false;
	}
